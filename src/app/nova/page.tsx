      ...
      <main className="max-w-7xl mx-auto px-4 md:px-6 py-8 pt-24 min-h-screen space-y-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-semibold uppercase tracking-wider">
            <SparklesIcon className="w-3.5 h-3.5" /> AI Dental Conversation Engine
          </div>
          ...
          <p className="text-muted-foreground text-sm md:text-base">
            Your 24/7 intelligent dental assistant. Ask questions about brushing techniques, tooth sensitivity, gum care, or common oral symptoms.
          </p>
        </div>
