        ...
        <div className="grid lg:grid-cols-12 gap-6 items-center relative z-10">
          ...
          <div className="lg:col-span-7 space-y-4 text-left">
            ...
            <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed max-w-lg">
              Get conversational dental guidance through the SmileSync AI voice
              experience. Speak naturally about your symptoms, care routines,
              and questions.
            </p>
            ...
            <div className="pt-1">
              <Link href="/voice">
                <Button
                  size="sm"
                  className="px-4 py-3 rounded-xl font-bold text-xs bg-primary hover:bg-primary/90 text-primary-foreground shadow-sm shadow-primary/20 gap-1.5"
                >
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative p-3.5 rounded-xl bg-card/70 border border-primary/20 shadow-md text-center space-y-2 w-full max-w-[200px]">
              ...
              <div className="flex items-center justify-center gap-1.5 h-8 px-3 py-1 bg-muted/30 rounded-xl border border-border/40">
                <span
                  className="w-1 bg-primary rounded-full animate-sound-wave h-3"
                  style={{ animationDelay: "0ms" }}
                />
                <span
                  className="w-1 bg-primary rounded-full animate-sound-wave h-6"
                  style={{ animationDelay: "150ms" }}
                />
                <span
                  className="w-1 bg-cyan-400 rounded-full animate-sound-wave h-4"
                  style={{ animationDelay: "300ms" }}
                />
                <span
                  className="w-1 bg-primary rounded-full animate-sound-wave h-7"
                  style={{ animationDelay: "450ms" }}
                />
                <span
                  className="w-1 bg-blue-500 rounded-full animate-sound-wave h-4"
