...
import { CalendarIcon, CrownIcon, HomeIcon, MicIcon, ActivityIcon, BotIcon, HeartPulseIcon, BellIcon, TrendingUpIcon } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center h-full">
        ...
        <div className="flex items-center gap-8">
          <Link href="/dashboard" className="flex items-center gap-2">
            <Image src="/logosmileai.png" alt="SmileSync AI Logo" width={32} height={32} className="w-11" />
          </Link>
          ...
          <div className="flex items-center gap-6">
            ...
            <Link
              ...
              className={`flex items-center gap-2 transition-colors hover:text-foreground ${
                pathname === "/insights" ? "text-foreground font-medium" : "text-muted-foreground"
              }`}
            >
              <TrendingUpIcon className="w-4 h-4 text-cyan-500" />
            ...
            <Link
              href="/care-plan"
              className={`flex items-center gap-2 transition-colors hover:text-foreground ${
                pathname === "/care-plan" ? "text-foreground font-medium" : "text-muted-foreground"
              }`}
            >
            ...
            <Link
              href="/assessment"
              className={`flex items-center gap-2 transition-colors hover:text-foreground ${
                pathname === "/assessment" ? "text-foreground font-medium" : "text-muted-foreground"
              }`}
            >
