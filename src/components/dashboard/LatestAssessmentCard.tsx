    ...
    <Card className="relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30">
      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          ...
          {latest && (
            <Badge
              variant={getBadgeVariant(latest.riskLevel)}
        ...
        {latest ? (
          <div className="space-y-3">
            ...
            <p className="text-xs text-muted-foreground line-clamp-2 leading-relaxed">
              {latest.nextStep ||
                "Regular oral health maintenance recommended."}
            </p>
          ...
          <div className="space-y-4 text-center py-2">
            <div className="p-4 rounded-xl bg-primary/5 border border-primary/10 space-y-1 text-left">
              <div className="font-semibold text-sm text-foreground flex items-center gap-1.5">
                <SparklesIcon className="w-4 h-4 text-primary" /> Evaluate Your
                Risk Factors
              </div>
              <p className="text-xs text-muted-foreground">
                Take our 2-minute structured questionnaire to receive
                personalized oral health guidance and risk score.
              </p>
            </div>
